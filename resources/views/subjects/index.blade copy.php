                        ...
                        <div
                            ...
                            <table class="min-w-full">
                                <thead>
                                    ...
                                    <th colspan="3" class="px-6 py-3 text-xs font-medium leading-4 tracking-wider text-left text-gray-500 uppercase border-b border-gray-200 bg-gray-50">
                                        Aktion
                                    </th>
                                </thead>
                                <tbody class="flex-1 sm:flex-none">
                                    ...
                                    <tr class="flex flex-col mb-2 flex-no wrap sm:table-row sm:mb-0 hover:bg-gray-100">
                                        ...
                                        <td class="text-sm font-medium leading-5 text-center whitespace-no-wrap border border-grey-light ">
                                            @if (Auth::user()->is_admin)
                                                <a href="{{ route('subjects.edit', $subject->id) }}" 
                                                    class="text-indigo-600 hover:text-indigo-900" title="Bearbeite Thema">
                                        ...
                                        <td class="text-sm font-medium leading-5 text-center whitespace-no-wrap border border-grey-light">
                                            <form action="{{ route('subjects.destroy', $subject) }}" method="POST" title="Lösche Thema"
                                                 onsubmit="return confirm('{{ trans('Wollen Sie wirklich löschen ? ') }}');">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="flex items-center" {{ !Auth::user()->is_admin ? 'disabled' : '' }}>
